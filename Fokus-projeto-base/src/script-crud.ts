...
let estadoInicial: EstadoAplicacao = {
    ...
    terefaSelecionada: null
 
}

const selecionaeTarefa = (estado: EstadoAplicacao, tarefa: Tarefa) => {
    return {
        ...estado,
        tarefaSelecionada: tarefa === estado.terefaSelecionada ? null : tarefa 
    }
}
...
const atualizarUI = () => {
    ...
    estadoInicial.tarefas.forEach(tarefa => {
        ...
        li.addEventListener('click', () => {
            ...
            estadoInicial = selecionaeTarefa(estadoInicial, tarefa)
            atualizarUI()
        })
